...
def scatter_plot_pca(projected_data, pc_1, pc_2):
    """Plot data points using scatter graph onto two specified principal components."""
     
    assert_message = 'scatter_plot_pca: two principal componets must be different for plot reasons, passed pc_1={} pc_2={}'.format(pc_1, pc_2)
    assert pc_1 != pc_2, assert_message
...
def scatter_plot_pca_2_components(projected_data):
     """Plot data points using scatter graph onto first two principal components.""" 
     scatter_plot_pca(projected_data, pc_1=0, pc_2=1)
     pass
